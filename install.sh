...
while true; do
  ...
  echo -e "${RED}ggg:     gg.     -   ,ggg       • Telegram : t.me/ext4you     ${NC}"
  echo -e "${WHITE} ggg:     ggg._    _,ggg        • Credit  : ZERO DEVELOPER ${NC}"
  echo -e "${WHITE} ggg.    '.'''ggggggp           • Support by Zero Developer  ${NC}"
